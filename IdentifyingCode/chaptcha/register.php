...
<body>
	<h1 style="font-family:'微软雅黑';">注册页面</h1>
		...
		<table bgcolor="#abcdef" width="80%" border="1" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td>
					...
					<img src="testChptcha.php" alt="" id="verifyImg">
					<a href="javascript:void(0);" onclick="document.getElementById('verifyImg').src='testChptcha.php?r='+Math.random()">看不清</a>
				</td>
			</tr>
			<tr>
